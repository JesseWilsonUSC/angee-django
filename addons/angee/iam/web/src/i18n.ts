...
export const enIamMessages: Record<string, string> = {
  ...
  "principalAccess.tab": "Access",
  "principalAccess.roles": "Roles",
  "principalAccess.grants": "Grants",
  "principalAccess.permissions": "Permissions",
  "principalAccess.role": "Role",
  "principalAccess.namespace": "Namespace",
  "principalAccess.target": "Target",
  "principalAccess.relation": "Relation",
  "principalAccess.permission": "Permission",
  "principalAccess.source": "Source",
  "principalAccess.scope": "Scope",
  "principalAccess.condition": "Condition",
  "principalAccess.direct": "Direct",
  "principalAccess.inherited": "Inherited",
  "principalAccess.noRoles": "No roles reach this principal.",
  "principalAccess.noGrants": "No explicit grants reach this principal.",
