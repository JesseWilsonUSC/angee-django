...
| django-zed-rebac >= 0.17.0 | REBAC engine, Zed introspection/rendering/extension, model subject identity, memberships and garbage collection, live ORM backing and lazy SQL permission scoping | Addon schema composition, resource grant policy and IAM product surfaces through public REBAC APIs |
